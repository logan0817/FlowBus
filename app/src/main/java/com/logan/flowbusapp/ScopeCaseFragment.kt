...
import com.logan.flowbusapp.databinding.FragmentScopeCaseBinding
...
class ScopeCaseFragment : Fragment() {

    companion object {
        private const val EVENT_FRAGMENT_PANEL_REFRESH = "fragment-panel-refresh"
    }

    private var _binding: FragmentScopeCaseBinding? = null
    private val binding get() = _binding!!

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        _binding = FragmentScopeCaseBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setListeners() {
        ...
        binding.btnSendLocalMessageToHost.setOnClickListener {
            ...
            postEventTo(owner = requireActivity(), event = ActivityEvent(ScopeCaseActivity.EVENT_FRAGMENT_TO_HOST))
        }
    }
