...
import com.logan.flowbusapp.databinding.ActivityStickyCaseBinding
import com.logan.flowbusapp.event.ActivityEvent

class StickyCaseActivity : AppCompatActivity() {
    ...
    private var _binding: ActivityStickyCaseBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityStickyCaseBinding.inflate(layoutInflater)
